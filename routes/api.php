...
Route::middleware('auth:sanctum')->group(function () {
   ...
   //Farms
    ...
    Route::match(['get', 'post'], 'getOrders', [SellerBuyerController::class, 'getOrders']);
...
// Route::post('/product_management', [ProductManagementController::class, 'addProduct']);
...
Route::get('/generateReport1', [SuperAdminController::class, 'generateReport']); //dashboard
