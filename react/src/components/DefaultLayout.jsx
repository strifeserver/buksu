  ...
  return (
    <div>
      ...
      >
        ...
        <div class="h-full py-4 overflow-y-auto bg-blue-500 dark:bg-blue-500">
          {/* STARTING */}

          <div className="w-64 absolute sm:relative bg-blue-500 shadow md:h-full flex-col justify-between flex">
            <div className="px-8">
              <div className="h-16 w-full flex items-center">
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <text x="10" y="30" class="text-4xl font-bold text-slate-100">
                    Admin
                  </text>
                </svg>
              </div>
              <ul className="mt-6">
                ...
                <Link to={"admin/users"}>
                  <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-white ml-2">Users</span>
                    </div>
                  </li>
                </Link>
                <hr className="m-4" />
                ...
                <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-slate-100 ml-2">Products</span>
                  </div>
                </li>
                </Link>
                <p className="text-slate-100 mt-8 mb-0">Transactions</p>
                <hr className="mb-4" />
                <Link to={"/orders/fulfilled"}>
                <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                  <div className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="text-sm text-white ml-2">Fulfilled Orders</span>
                  </div>
                </li>
                </Link>
                <p className="text-slate-100 mt-8 mb-0">Records</p>
                <hr className="mb-4" />
                <Link to={"/admin/croprecords"}>
                <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                  <div className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="text-sm text-white ml-2">Crop Records</span>
                  </div>
                </li>
                </Link>
                <p className="text-slate-100 mt-8 mb-0">App Options</p>
                <hr className="mb-4" />
                <Link to={"/admin/supported/barangay"}>
                <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                  <div className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="text-sm text-white ml-2">Supported Barangay's</span>
                  </div>
                </li>
                </Link>
                <Link to={"/admin/supported/products"}>
                <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                  <div className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="text-sm text-white ml-2">Supported Product's</span>
                  </div>
                </li>
                </Link>
                ...
                <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-white ml-2">Profile</span>
                  </div>
                </li>
              </ul>
            </div>
