                ...
                <div className="flex items-center justify-between">
                    <div className="lg:w-3/12">
                        <div className="w-7/12 hidden lg:flex items-center space-x-3 border-b border-gray-200 pb-2">
                            ...
                            <p className="bg-transparent text-md text-gray-600 focus:outline-none"> {userName}</p>
                        </div>
                    ...
                    <div className="lg:w-6/12 flex flex-col justify-center items-center space-y-3.5">
                        <div aria-label="Etabo. Logo" role="img" className="cursor-pointer">
                            <img src='/logo.jpg' alt="" width={150} height={40}/>
                        </div>
                        <div className="hidden lg:block">
                            <ul className="flex items-center space-x-10">
                                <li>
                                    <a href="/buyer/home" className="dark:text-white dark:hover:text-gray-300 text-base text-gray-800 hover:text-white">
                                        Home
                                    </a>
                                </li>

                                <li>
                                    <a href="/buyer/order/products" className="dark:text-white dark:hover:text-gray-300 text-base text-gray-800 hover:text-white">
                                   Products
                                    </a>
                                </li>

                                <li>
                                    <a href="javascript:void(0)"  className="dark:text-white dark:hover:text-gray-300 text-base text-gray-800 hover:text-white">
                                        Orders
                                    </a>
                                </li>
                            </ul>
